...
#
# Purpose:
#   Creates the .intunewin package for the WSL2 deployment.
#
# Author: Ops Team
...
$tempDir = Join-Path ([System.IO.Path]::GetTempPath()) "wsl2-build-$([System.Guid]::NewGuid().ToString('N').Substring(0,8))"
...
$builtFile = Join-Path $tempDir $OUTPUT_FILE
