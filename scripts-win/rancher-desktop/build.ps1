...
#
# Purpose:
#   Creates the .intunewin package for the Rancher Desktop deployment.
#
# Author: Ops Team
...
$OUTPUT_FILE        = "rancher-desktop-install.intunewin"
...
$tempDir = Join-Path ([System.IO.Path]::GetTempPath()) "rancher-build-$([System.Guid]::NewGuid().ToString('N').Substring(0,8))"
