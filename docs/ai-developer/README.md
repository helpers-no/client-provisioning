...
In this repo that is [project-client-provisioning.md](project-client-provisioning.md) (with [project-azure-devops.md](project-azure-devops.md)). Read it before doing anything else.
